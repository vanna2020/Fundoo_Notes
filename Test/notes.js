...
describe('create notes api', () => {
    it('givenNotes InValidToken', (done) => {
    ...
    it('givenNotes validToken is Authentic Request', (done) => {
    ...
    it('givenNotes in ValidToken is not Authentic', (done) => {
        const token = noteDB.notes.invalidToken;
        chai
            .request(server)
            .post('/createnotes')
    ...
    it('givenNotes Valid Token shouldCreated', (done) => {
        const token = noteDB.notes.validToken;
        const createNotes = {
...
describe('get note By id Api', () => {
    ...
    it('From Id Verifying the Note by using .findOne Method', (done) => {
        ...
        chai
            .request(server)
            .get('/getnotes/61d5bafe88e4accc731fc318')
            .set({ authorization: token })
            .end((err, res) => {
                res.should.have.status(201);
                done();
...
describe('Update Note api', () => {
    ...
    it('given Proper Details Should Update Note Using Fake Data', (done) => {
        ...
        chai
            .request(server)
            .put('/updatenotes/61d5bafe88e4accc731fc318')
            .set({ authorization: token })
            .send(createNotes)
            .end((err, res) => {
                res.should.have.status(201);
...
describe('Delete Note By Id api', () => {
    ...
    it('validToken should give true when it is valid entry of token', (done) => {
        ...
        chai
            .request(server)
            .delete('/deletenotes/61d5bafe88e4accc731fc318')
            .set({ authorization: token })
            .end((err, res) => {
                res.should.have.status(201);
                done();
